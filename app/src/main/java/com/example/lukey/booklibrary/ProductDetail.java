...
import com.example.lukey.booklibrary.Model.Rating;
...
public class ProductDetail extends AppCompatActivity implements RatingDialogListener {
    ...
    TextView product_name,product_price,product_author,product_barcode,product_qty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_author = (TextView)findViewById(R.id.product_author);
    ...
    private void getDetailProduct(String productId) {
        products.child(productId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                product_author.setText(String.format("Product Author : %s",currentProduct.getAuthor()));
    ...
    public void onPositiveButtonClicked(int value, @NotNull String comments) {
        ...
        ratingTbl.child(Common.currentUser.getUserName()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Toast.makeText(ProductDetail.this, "Thnaks for the feedback", Toast.LENGTH_SHORT).show();
